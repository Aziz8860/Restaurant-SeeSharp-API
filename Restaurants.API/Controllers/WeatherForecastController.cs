...
public class WeatherForecastController : ControllerBase
{
    ...
    //private readonly WeatherForecastService _weatherForecastService = new(); // Tanpa Dependency Injection
    ...
    public IActionResult Generate([FromQuery]int count, [FromBody] TemperatureRequest request)
    {
        ...
        {
            return BadRequest("Count has to be positive and max must be greater than min");
        }
